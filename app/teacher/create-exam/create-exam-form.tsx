...
export default function CreateExamForm({ error }: CreateExamFormProps) {
  ...
  const defaultDeadline = formatDateTimeLocal(new Date(now.getTime() + 14 * 24 * 60 * 60 * 1000)) // 2 weeks from now
      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>Create a new timed exam with strict time limits</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                {showPreview ? (
                  ...
                  <Textarea
                    ...
                    placeholder="Enter exam description and instructions (supports Markdown formatting)"
                    rows={4}
                    required
                  />
                )}
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500">When students can see this exam</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500">When students must complete by</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500">Duration for the exam</p>
                </div>
              </div>
