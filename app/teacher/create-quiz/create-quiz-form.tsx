...
export default function CreateQuizForm({ error }: CreateQuizFormProps) {
  ...
  const defaultDeadline = formatDateTimeLocal(new Date(now.getTime() + 7 * 24 * 60 * 60 * 1000))
              ...
              <div className="space-y-2">
                ...
                {showPreview ? (
                  ...
                  <Textarea
                    ...
                    placeholder="Enter quiz description and instructions (supports Markdown formatting)"
                    rows={4}
                    required
                  />
                )}
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500">When students can see this quiz</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500">Duration for the quiz</p>
                </div>
              </div>
